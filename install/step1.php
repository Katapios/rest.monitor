...
<form action="<?php echo $APPLICATION->GetCurPage(); ?>" method="post">
    ...
    <!-- Поле URL -->
    <label for="opensearch_url"><?php echo Loc::getMessage("REST_MONITOR_OPENSEARCH_URL"); ?>:</label><br>
    <input type="text" name="opensearch_url" id="opensearch_url" size="50" value="http://localhost:9200"><br><br>
